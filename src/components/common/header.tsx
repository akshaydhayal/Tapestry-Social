  ...
  return (
    <header className="hidden sm:flex flex-col w-[88px] xl:w-[275px] h-screen sticky top-0 pb-4 pt-1 px-2 xl:px-4 border-r border-zinc-900 justify-start shrink-0">
      <div className="flex flex-col gap-2 xl:gap-1 items-center xl:items-start w-full">
        ...
        {/* Popular Subnets Section */}
        <div className="hidden xl:flex flex-col gap-4 mt-8 px-2 w-full">
          <h3 className="text-[13px] font-black text-zinc-500 tracking-widest uppercase px-1">
            Popular Subnets
          </h3>
          <div className="flex flex-col gap-1">
            <Link href="/subnets" className="group flex items-center justify-between py-2 px-1 rounded-xl transition-all hover:bg-zinc-900">
              <span className="text-[17px] font-bold text-zinc-100 group-hover:text-white transition-colors">#SolanaDevs</span>
              <span className="text-[11px] font-medium text-zinc-500 bg-zinc-900 px-2 py-1 rounded-md border border-zinc-800">Rep &gt; 100</span>
            </Link>
            <Link href="/subnets" className="group flex items-center justify-between py-2 px-1 rounded-xl transition-all hover:bg-zinc-900">
              <span className="text-[17px] font-bold text-zinc-100 group-hover:text-white transition-colors">#DeFiDegens</span>
              <span className="text-[11px] font-medium text-zinc-500 bg-zinc-900 px-2 py-1 rounded-md border border-zinc-800">Public</span>
            </Link>
            <Link href="/subnets" className="group flex items-center justify-between py-2 px-1 rounded-xl transition-all hover:bg-zinc-900">
              <span className="text-[17px] font-bold text-zinc-100 group-hover:text-white transition-colors">#NFTWhales</span>
